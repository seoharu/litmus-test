...
#MINETYPE설정하기
import mimetypes
mimetypes.add_type("image/svg", ".svg", True)
import os
...
EMAIL_HOST_USER = 'alphasobs@jbnu.ac.kr'
EMAIL_HOST_PASSWORD = ''
EMAIL_PORT = 587
...
SITE_NAME = 'Litmus@JBNU'
SITE_LONG_NAME = 'Online Judge for JBNU'
